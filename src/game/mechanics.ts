 ...
 * рендер — для каждой частицы потока, звук — для порывов каньона. Второй
 * формулы быть не должно — разъехавшиеся телеграф и физика делают игру
...
/** Нормированная сила потока, −1…1. По ней звук ведёт порывы каньона. */
