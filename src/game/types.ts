...
export interface GameState {
   ...
   * фиксированного шага (TASK.md, раздел 2): по ним рендер ставит птицу и
   * досдвигает трубы на долю шага.
   */
   ...
   * `travelledX + x`; по ней считаются зоны `airflow`, и по ней же рендер
   * двигает частицы потока. Копится тем же интегралом, что двигает трубы, поэтому
