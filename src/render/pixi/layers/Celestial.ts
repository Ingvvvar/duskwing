 ...
 * 0.32 — это ещё и 45% от яркости трубы, то есть контракт читаемости
 * выполняется и для отдельного элемента, а не только по перцентилю.
 */
const DISC_LUMINANCE = 0.32;
